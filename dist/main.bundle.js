...
var communitiesComponent = (function () {
    function communitiesComponent(router, fb, apiService, sharedService, segment) {
        ...
        this.filter = '';
        this.newmap = null;
        this.headerTitle = { first_name: 'Gateway', primary_color: '#003C6B', last_name: 'Lifestyle', secondary_color: '#62717f' };
        //sorting
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__community_resolver__ = __webpack_require__("../../../../../src/app/community/community-resolver.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__community_slug_resolver__ = __webpack_require__("../../../../../src/app/community/community-slug-resolver.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__communities_component__ = __webpack_require__("../../../../../src/app/community/communities.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__community_component__ = __webpack_require__("../../../../../src/app/community/community.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_safe_pipe__ = __webpack_require__("../../../../safe-pipe/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_safe_pipe___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_safe_pipe__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var settingsRouting = __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* RouterModule */].forChild([
    {
        path: 'communities',
        component: __WEBPACK_IMPORTED_MODULE_4__communities_component__["a" /* communitiesComponent */]
    },
    {
        path: ':slug',
        component: __WEBPACK_IMPORTED_MODULE_5__community_component__["a" /* communityComponent */],
        resolve: {
            community: __WEBPACK_IMPORTED_MODULE_2__community_resolver__["a" /* CommuntyResolver */]
        }
    },
    {
        path: 'community/:slug',
        component: __WEBPACK_IMPORTED_MODULE_5__community_component__["a" /* communityComponent */],
        resolve: {
            community: __WEBPACK_IMPORTED_MODULE_3__community_slug_resolver__["a" /* CommuntySlugResolver */]
        }
    }
]);
var communitiesModule = (function () {
    ...
    communitiesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_6__shared__["g" /* SharedModule */],
                settingsRouting,
                ...
                __WEBPACK_IMPORTED_MODULE_9_safe_pipe__["SafePipeModule"]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__communities_component__["a" /* communitiesComponent */],
                __WEBPACK_IMPORTED_MODULE_5__community_component__["a" /* communityComponent */]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_2__community_resolver__["a" /* CommuntyResolver */],
                __WEBPACK_IMPORTED_MODULE_3__community_slug_resolver__["a" /* CommuntySlugResolver */]
            ]
        })
    ], communitiesModule);
...
var HomeComponent = (function () {
    function HomeComponent(router, apiService, segment) {
        this.router = router;
        this.apiService = apiService;
        this.segment = segment;
        this.header = "";
...
var HeaderComponent = (function () {
    function HeaderComponent(router, apiService, segment, sharedService) {
        this.router = router;
        this.apiService = apiService;
        this.segment = segment;
        this.sharedService = sharedService;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.sharedService.caseNumber$.subscribe(function (data) {
            ...
            console.log(_this.communityTitle);
        });
    };
